...
public enum ErrorCode {
    // General errors
    KEY_INVALID(1001, "Uncateeeeg error", HttpStatus.BAD_REQUEST),
    ...
    PASSWORD_INVALID(1005, "Password must be between cvf dsfv  6 and 50 characters in length", HttpStatus.BAD_REQUEST),
